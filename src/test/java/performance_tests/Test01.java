...
/**
 * Register NUMBER_OF_USERS users and login them. Note: remember to delete the e-mails from the database.
 *
 * @author Noris
 * @date 2015/04/21
 */
class Test01 {
    ...
    public static void main(String[] args) throws JSONException {
        ...
        for (int i = 0; i < NUMBER_OF_USERS; i++) {
            ...
            System.out.println("[" + i + "] SERVER Registration Message: " + register.start(jsonRegFromClient) + "\n");
