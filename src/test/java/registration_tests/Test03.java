...
class Test03 {
    ...
    public static void main(String[] args) throws JSONException {
        ...
        jsonRegFromClientCopy.put(RegisterFields.EMAIL.toString(), randomUsername + "@atom.com");
        System.out.println("CLIENT Registration Message: " + jsonRegFromClient);

        // SERVER: Try to register the user
        System.out.println("SERVER Registration Message: " + register.start(jsonRegFromClientCopy) + "\n");
    }
