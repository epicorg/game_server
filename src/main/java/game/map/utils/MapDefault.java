...
public class MapDefault {
    ...
    /**
     * Builds the borders of the map.
     */
    public static void constructBorders(IMap mapJSONizer, MapDimension mapSize, Double wallSize, String texture) {
    ...
    /**
     * Builds the borders of the map with the default wall size.
     */
    public static void constructBorders(IMap mapJSONizer, MapDimension mapSize, String texture) {
