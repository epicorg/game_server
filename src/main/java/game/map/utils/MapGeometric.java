...
public class MapGeometric {
     ...
     * @param center   the point that must be checked
     * @param radius   the tolerance radius
    ...
    /**
     * @param position  a position
     * @param positions the points that must be checked
     * @param radius    the tolerance radius
     * @return true if the area of at least one circle's center of the array is already used, false otherwise
     */
    public static boolean checkIfUsed(MapDimension position, ArrayList<MapDimension> positions, double radius) {
    ...
    public static ArrayList<MapDimension> getWallPoints(MapDimension position, MapDimension size) {
        ...
        ArrayList<MapDimension> points = new ArrayList<>(2);
     ...
     * @param l1 a point of the line
     * @param l2 another point of the line
    ...
    public static boolean isPointOnLine(MapDimension p, MapDimension l1, MapDimension l2) {
        return Line2D.ptLineDist(l1.getWidth(), l1.getLength(), l2.getWidth(), l2.getLength(), p.getWidth(), p.getLength()) == 0;
    }

    /**
     * @param points an array of positions
     * @param l1     a point of the line
     * @param l2     another point of the line
     * @return true if at least one point of the array is on the line, false otherwise
     */
    ...
    /**
     * @param p  point position
     * @param l1 the first end of the segment
     * @param l2 the second end of the segment
    ...
    public static boolean isPointOnSegment(MapDimension p, MapDimension l1, MapDimension l2) {
        return Line2D.ptSegDist(l1.getWidth(), l1.getLength(), l2.getWidth(), l2.getLength(), p.getWidth(), p.getLength()) == 0;
    }
     ...
     * @param l1     the first end of the segment
     * @param l2     the second end of the segment
     * @return true if at least one point of the array is on the segment, false otherwise
     */
     ...
     */
    public static boolean isCircleOnSegment(MapDimension center, double radius, MapDimension l1, MapDimension l2) {
        ...
        return line.ptSegDist(point) <= radius;
    }

    /**
     * @param centers an array of circle's centers positions
     * @param radius  the radius of every circle
     * @param l1      the first end of the segment
     * @param l2      the second end of the segment
     * @return true if at least one circle of the array intersects the segment,
     * false otherwise
     */
    public static boolean isCircleOnSegment(ArrayList<MapDimension> centers, double radius, MapDimension l1, MapDimension l2) {
