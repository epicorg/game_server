...
/**
 * A thread related to Room making same cleaning if the room is empty. It checks at fixed time if the room can be
 * cancelled. This is a temporary solutions. It doesn't take into account the inactivity time of a <code>Room</code>,
 * it just checks if the <code>Room</code> is empty.
 *
 * @author Micieli
 * @see Room
 * @see GameDataManager
