...
/**
 * Contains methods for check registration fields in client request to create an account on the server. The data choose
 * by the user must be compatible with the ones defined in {@link FieldsValues}.
 *
 * @author Noris
 * @date 2015/03/28
 * @see Register
...
public class RegisterChecker {
     ...
     * @return true if they aren't user registered with the given e-mail
