...
/**
 * This class is responsible for the online users managing. A client login message is decoded by the {@link Login}
 * service who, with its method code>setUserOnline</code>, calls the <code>setOnline</code> method of this class. Then
 * the user is added to <code>onlineUsers</code> HashMap, that contains all the online users at any moment.
 *
 * @author Noris
 * @date 2015/03/30
 * @see OnlineUser
...
public class OnlineManager {
    ...
    private HashMap<String, OnlineUser> onlineUsers = new HashMap<>();
     ...
     * @param hashCode the user's hashcode
     * @throws UserNotOnlineException if the user isn't online
     */
