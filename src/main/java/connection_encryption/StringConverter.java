...
public class StringConverter {
	...
	/**
	 * Converts an array of bytes into a string, using Base 64 encoding schemes (with a no wrap encoding).
	 * 
	 ...
	 * 
	 * @param string a string encoded using Base 64 encoding schemes
