...
public class UsersDataManager {
     ...
     * @return true if they aren't user registered with the given email
    ...
    /**
     * Checks if the password given by the user matches with the one provided during the registration.
     *
