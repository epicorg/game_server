...
/**
 * A {@link Game} sub-service. The client has to send to the server, at a fixed rate, his position in the map. This
 * service updates his saved position in the server and also updates the client about the other {@link Player}s positions.
 *
 * @author Micieli
 * @date 2015/05/24
 * @see PlayerStatus
...
public class GamePositions implements IService {
    ...
    private void UpdatePlayerStatus(String username, JSONObject request, Room room) throws JSONException, NoSuchPlayerException {
