...
/**
 * <code>Login</code> service allows the client to access to others services. The {@link OnlineManager} provides
 * functions to manage {@link OnlineUser}. Before logging in a user must be registered. The client has to provide his
