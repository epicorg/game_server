...
public class CurrentRoomMessagesCreator {
    ...
    /**
     * Generates a players list, informing the client about the players who are in the {@link Room}.
     *
     * @param room the room from which take the players list
    ...
    private JSONArray formatPlayers(Team t) throws JSONException {
        ...
        for (Player player : t.getPlayers()) {
            ...
            jObject.put(CommonFields.USERNAME.toString(), player.getUsername());
            players.put(jObject);
        }
        return players;
    }
