...
public class GameMessagesCreator {
    ...
    /**
     * Generates a message containing all the positions of currently playing players of a room. It excludes the
     * receiver from the message.
     *
     * @param username the username of the receiver client
    ...
    /**
     * Creates a message containing the description of a map and the spawn point.
     *
     * @param map        a <code>JSONObject</code> containing the map
     * @param spawnPoint a <code>PlayerStatus</code> containing the initial position
     * @see PlayerStatus
     * @see MapJSONizer
     */
